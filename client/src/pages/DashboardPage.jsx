...
import { Phone, DollarSign, Clock, BarChart3, LogOut, ArrowLeft } from 'lucide-react';
    ...
    return (
         ...
         */}
         ...
         <div className="flex items-center space-x-4">
           <img src={logo} alt="Vapi Logo" className="h-20 w-20" />
          <div>
            <h1 className="text-4xl font-bold text-white leading-tight">Vapi Call Analytics</h1>
            <p className="text-gray-400 mt-1 text-sm sm:text-base">
                        Viewing Dashboard for: <span className="font-semibold text-gray-100">{currentClientDisplayInfo}</span>
                    </p> 
         </div>
